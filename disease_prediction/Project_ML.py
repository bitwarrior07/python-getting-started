...
depth = range(1,30)
for n in depth:
    tree_test = RandomForestClassifier(max_depth=n)
    tree_test.fit(x_train, y_train.values.ravel())
    train_accuracy.append(tree_test.score(x_train, y_train))
